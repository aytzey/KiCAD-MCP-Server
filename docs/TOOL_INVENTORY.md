...
**Current Registry:** 182 distinct tools; 157 routed tools in 16 categories
**Last Updated:** 2026-09-04

> The detailed tables below originated as a 137-tool snapshot and remain useful
> for per-tool descriptions. The executable `src/tools/registry.ts` and its
> completeness tests are authoritative for current names and totals.
...
| **Current distinct registry total** | **182** | Verified by automated registry tests     |
...
> **Verified:** automated registry and README-count tests report **182** distinct
> tools, including **157** tools indexed across **16** routed categories.

## Token Impact

All registered tools are available directly. The discovery tools in `router.ts`
also let the model search the 157 routed tools by category or keyword.
