...
export const toolCategories: ToolCategory[] = [
  ...
  },
  {
    name: "manufacturing",
    description:
      "Two-layer production readiness and atomic fabrication/assembly package generation",
    tools: ["analyze_manufacturing_readiness", "prepare_manufacturing_package"],
  },
  {
    name: "autoroute",
    description:
      "Constraint-first hybrid autorouting, critical-net protection, Freerouting bulk routing, and QoR verification",
    tools: [
      "autoroute",
      "autoroute_cfha",
