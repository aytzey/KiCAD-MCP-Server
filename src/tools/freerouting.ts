...
import { z } from "zod";
import { routingOrchestrationArgs } from "./cfha.js";
...
export function registerFreeroutingTools(server: McpServer, callKicadScript: Function) {
  ...
  server.tool(
    "autoroute",
    "Default production autorouter. Runs the constraint-first hybrid pipeline: board audit, intent/rule synthesis, protected critical-net routing, controlled Freerouting bulk routing, post-tuning, and DRC/QoR verification. Set attempts > 1 for best-of-N bulk routing.",
    {
